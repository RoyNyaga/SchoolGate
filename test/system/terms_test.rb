...
class TermsTest < ApplicationSystemTestCase
  ...
  test "should create term" do
    ...
    fill_in "Academic year end", with: @term.academic_year_end
    fill_in "Academic year start", with: @term.academic_year_start
    fill_in "School", with: @term.school_id
    fill_in "Term type", with: @term.term_type
