...
class CompetencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competence" do
    assert_difference("Competence.count") do
      post competences_url, params: { competence: { school_class_id: @competence.school_class_id, school_id: @competence.school_id, suubject_id: @competence.suubject_id, title: @competence.title } }
    end
  ...
  test "should update competence" do
    patch competence_url(@competence), params: { competence: { school_class_id: @competence.school_class_id, school_id: @competence.school_id, suubject_id: @competence.suubject_id, title: @competence.title } }
