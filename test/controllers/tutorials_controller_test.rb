...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference("Tutorial.count") do
      post tutorials_url, params: { tutorial: { slug: @tutorial.slug, title: @tutorial.title, views: @tutorial.views, youtube_frame: @tutorial.youtube_frame } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { slug: @tutorial.slug, title: @tutorial.title, views: @tutorial.views, youtube_frame: @tutorial.youtube_frame } }
