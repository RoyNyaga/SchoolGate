...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference("Deposit.count") do
      post deposits_url, params: { deposit: { amount: @deposit.amount, approval: @deposit.approval, description: @deposit.description, origin: @deposit.origin, school_id: @deposit.school_id, teacher_id: @deposit.teacher_id } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { amount: @deposit.amount, approval: @deposit.approval, description: @deposit.description, origin: @deposit.origin, school_id: @deposit.school_id, teacher_id: @deposit.teacher_id } }
