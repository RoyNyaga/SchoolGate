...
class AcademicYearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create academic_year" do
    assert_difference("AcademicYear.count") do
      post academic_years_url, params: { academic_year: { is_active: @academic_year.is_active, year: @academic_year.year } }
    end
  ...
  test "should update academic_year" do
    patch academic_year_url(@academic_year), params: { academic_year: { is_active: @academic_year.is_active, year: @academic_year.year } }
