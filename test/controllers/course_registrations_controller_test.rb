...
class CourseRegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_registration" do
    assert_difference("CourseRegistration.count") do
      post course_registrations_url, params: { course_registration: { academic_year_id: @course_registration.academic_year_id, courses: @course_registration.courses, credit_val: @course_registration.credit_val, school_id: @course_registration.school_id, semester_id: @course_registration.semester_id, student_id: @course_registration.student_id } }
    end
  ...
  test "should update course_registration" do
    patch course_registration_url(@course_registration), params: { course_registration: { academic_year_id: @course_registration.academic_year_id, courses: @course_registration.courses, credit_val: @course_registration.credit_val, school_id: @course_registration.school_id, semester_id: @course_registration.semester_id, student_id: @course_registration.student_id } }
