...
ActiveRecord::Schema[7.1].define(version: 2024_11_30_205749) do
  ...
  create_table "invitations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "teachers_phone_number", default: "", null: false
  ...
  create_table "performance_sheets", force: :cascade do |t|
    ...
    t.integer "category"
    t.text "sequences_with_issues", default: [], array: true
    t.text "subjects_with_issues", default: [], array: true
  ...
  create_table "proprietor_ques", force: :cascade do |t|
    t.string "full_name"
    t.string "phone_number"
  ...
  create_table "school_approval_requests", force: :cascade do |t|
    t.bigint "school_id", null: false
    t.bigint "teacher_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["school_id"], name: "index_school_approval_requests_on_school_id"
    t.index ["teacher_id"], name: "index_school_approval_requests_on_teacher_id"
  end
  ...
  add_foreign_key "school_approval_requests", "schools"
  add_foreign_key "school_approval_requests", "teachers"
