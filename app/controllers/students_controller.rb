class StudentsController < ApplicationController
  ...
  def id_card
    qrcode = RQRCode::QRCode.new("https://school-gate-0e6fc8fcd208.herokuapp.com/#{@student.id}")
    @svg = qrcode.as_svg(
      color: "000",
  ...
  def student_params
    params.require(:student).permit(:school_id, :school_class_id, :fathers_name, :fathers_contact,
                                    ...
                                    :town, :first_name, :last_name, :department_id, :faculty_id, :education_level, :contact, :gender)
  end
